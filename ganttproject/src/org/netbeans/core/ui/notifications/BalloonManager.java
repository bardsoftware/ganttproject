...
public class BalloonManager {
    ...
    private static class Balloon extends JPanel {
        ...
        public Balloon( final JComponent content, final ActionListener defaultAction, final ActionListener dismissAction, final int timeoutMillis ) {
            ...
            add( content, new GridBagConstraints(0,0,1,1,1.0,1.0,GridBagConstraints.NORTH,GridBagConstraints.BOTH,new Insets(7,7,7,7),0,0));
        ...
        private static final Color defaultGradientStartColor = Color.YELLOW;
        private static final Color defaultGradientFinishColor = Color.YELLOW;
    }

    static class DismissButton extends JButton {

        public DismissButton() {
            setIcon(new ImageIcon(getClass().getResource("/icons/netbeans/dismiss_enabled.png")));
            setRolloverIcon(new ImageIcon(getClass().getResource("/icons/netbeans/dismiss_rollover.png")));
            setPressedIcon(new ImageIcon(getClass().getResource("/icons/netbeans/dismiss_pressed.png")));
