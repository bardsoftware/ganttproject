...
import biz.ganttproject.customproperty.PropertyTypeEncoder.encodeFieldType

class CustomColumn internal constructor(
  ...
  override var defaultValueAsString: String?
    ...
    set(value) {
      val stub = decodeTypeAndDefaultValue(typeAsString, value)
      defaultValue = stub.defaultValue
    }

  override val typeAsString get() = encodeFieldType(type) ?: CustomPropertyClass.TEXT.iD
