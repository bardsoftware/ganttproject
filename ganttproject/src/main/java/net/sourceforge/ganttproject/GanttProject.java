...
import net.sourceforge.ganttproject.storage.H2InMemoryStorageFactory;
...
public class GanttProject extends GanttProjectBase implements ResourceView, GanttLanguage.Listener {
  ...
  public GanttProject(boolean isOnlyViewer) {
    ...
    addProjectEventListener(new ProjectStateHolderEventListener(new H2InMemoryStorageFactory()));
