...
public class ColorConstants {
  ...
  public static final Color[] SHORT_LIST = { BLACK, WHITE, RED, GREEN, BLUE, CYAN, PINK, MAGENTA, ORANGE, YELLOW,
      KHAKI, TAN, BROWN, GOLD, NAVY, PURPLE, TURQUOISE, VIOLET, MAROON, SALMON, GRAY };

  public static final Color[] MEDIUM_LIST = { AQUAMARINE, AZURE, BEIGE, BISQUE, BLACK, BLUE, BROWN, CHARTREUSE,
      CHOCOLATE, CORAL, CORNSILK, CYAN, GREEN, GAINSBORO, GOLD, GOLDENROD, GRAY, HONEYDEW, IVORY, KHAKI, LAVENDER,
      LINEN, MAGENTA, MAROON, MOCCASIN, NAVY, ORANGE, ORCHID, PERU, PINK, PLUM, PURPLE, RED, SALMON, SEASHELL, SIENNA,
      SNOW, TAN, THISTLE, TOMATO, TURQUOISE, VIOLET, WHEAT, WHITE, YELLOW };

  public static final Color[] LONG_LIST = { ALICE_BLUE, ANTIQUE_WHITE, AQUAMARINE, AZURE, BEIGE, BISQUE, BLACK,
      BLANCHED_ALMOND, BLUE, BLUE_VIOLET, BROWN, BURLY_WOOD, CADET_BLUE, CHARTREUSE, CHOCOLATE, CORAL, CORNFLOWER_BLUE,
      CORNSILK, CYAN, DARK_GOLDENROD, DARK_GREEN, DARK_KHAKI, DARK_OLIVE_GREEN, DARK_ORANGE, DARK_ORCHID, DARK_SALMON,
      DARK_SEA_GREEN, DARK_SLATE_BLUE, DARK_SLATE_GRAY, DARK_TURQUOISE, DARK_VIOLET, DEEP_PINK, DEEP_SKY_BLUE,
      DIM_GRAY, DODGER_BLUE, FIRE_BRICK, FLORAL_WHITE, FOREST_GREEN, GREEN, GAINSBORO, GHOST_WHITE, GOLD, GOLDENROD,
      GRAY, HONEYDEW, HOT_PINK, INDIAN_RED, IVORY, KHAKI, LAVENDER, LAVENDER_BLUSH, LAWN_GREEN, LEMON_CHIFFON,
      LIGHT_BLUE, LIGHT_CORAL, LIGHT_CYAN, LIGHT_GOLDENROD, LIGHT_GOLDENROD_YELLOW, LIGHT_GRAY, LIGHT_GREY, LIGHT_PINK,
      LIGHT_SALMON, LIGHT_SEA_GREEN, LIGHT_SKY_BLUE, LIGHT_SLATE_BLUE, LIGHT_SLATE_GRAY, LIGHT_SLATE_GREY,
      LIGHT_STEEL_BLUE, LIGHT_YELLOW, LIME_GREEN, LINEN, MAGENTA, MAROON, MEDIUM_AQUAMARINE, MEDIUM_BLUE,
      MEDIUM_ORCHID, MEDIUM_PURPLE, MEDIUM_SEA_GREEN, MEDIUM_SLATE_BLUE, MEDIUM_SPRING_GREEN, MEDIUM_TURQUOISE,
      MEDIUM_VIOLET_RED, MIDNIGHT_BLUE, MINT_CREAM, MISTY_ROSE, MOCCASIN, NAVAJO_WHITE, NAVY, NAVY_BLUE, OLD_LACE,
      ...
      SANDY_BROWN, SEA_GREEN, SEASHELL, SIENNA, SKY_BLUE, SLATE_BLUE, SLATE_GRAY, SNOW, SPRING_GREEN, STEEL_BLUE, TAN,
      THISTLE, TOMATO, TURQUOISE, VIOLET, VIOLET_RED, WHEAT, WHITE, WHITE_SMOKE, YELLOW, YELLOW_GREEN };
}
