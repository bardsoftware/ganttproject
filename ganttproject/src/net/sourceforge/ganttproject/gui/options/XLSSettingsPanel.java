 ...
 * @author athomas
 */
public class XLSSettingsPanel extends GeneralOptionPanel {

  private JComboBox cbTextSeparator;
  private final CSVOptions myXlsOptions;

  private JComboBox myFieldSeparatorCombo;

  public XLSSettingsPanel(UIFacade uiFacade, CSVOptions myXlsOptions) {
    super(uiFacade, language.getCorrectedLabel("xlsexport"), language.getText("settingsXlsExport"));
    this.myXlsOptions = myXlsOptions;
