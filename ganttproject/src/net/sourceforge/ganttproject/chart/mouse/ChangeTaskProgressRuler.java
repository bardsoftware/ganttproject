...
/**
 * Helper class for converting screen pixels into task completion percentage value
 * when changing the latter with a mouse. It operates with pixel offsets from the chart
 * viewport origin.
 *
