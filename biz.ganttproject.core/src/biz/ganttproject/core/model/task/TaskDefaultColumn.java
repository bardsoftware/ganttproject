...
public enum TaskDefaultColumn {
  ...
  COST2(new ColumnList.ColumnStub("tpd13", null, false, -1, 20), Double.class, "tableColCost2"),
  RESOURCES(new ColumnList.ColumnStub("tpd14", null, false, -1, 20), String.class, "resources", Functions.NOT_EDITABLE);
