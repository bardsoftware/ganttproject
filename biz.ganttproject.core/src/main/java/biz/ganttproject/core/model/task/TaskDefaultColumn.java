...
public enum TaskDefaultColumn {
  ...
  DURATION(new ColumnList.ColumnStub("tpd6", null, true, -1, 50), Integer.class, "tableColDuration", null),
  COMPLETION(new ColumnList.ColumnStub("tpd7", null, true, -1, 50), Integer.class, "tableColCompletion"),
