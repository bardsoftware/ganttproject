...
"%JAVA_COMMAND%" -Xmx512m -classpath "%CLASSPATH%;%LOCAL_CLASSPATH%" -ea -Dsun.java2d.d3d=false %BOOT_CLASS% -plugins-dir plugins -app net.sourceforge.ganttproject.GanttProject -log true  %1 %2 %3 %4 %5 %6
